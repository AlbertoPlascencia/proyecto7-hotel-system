...
$fecha = date("Y-m-d"); // Agregar la fecha actual
    ...
    $sql = "INSERT INTO encuesta_hotel2 (nombre, whatsapp,  terrazayareas, albercasdehotel_toboganes, albercasdehotel_rampa, albercaparaniños, CHAPOTEADEROS, ALBERCASEMIOLIMPICA, JACUZZIS, TEMAZCAL, BAÑOS, elvelero, pergola, lasdelicias, doñatoña, cocobar, MINIBAR, MESEROS, CAJERAS, PERSONAL, TERMAS, MASAJES, TRATAMIENTOS, TERMASVIP, feedback, fecha )
    VALUES ('$nombre', '$whatsapp', '$terrazayareas', '$albercasdehotel_toboganes', '$albercasdehotel_rampa', '$albercaparaniños', '$CHAPOTEADEROS', '$ALBERCASEMIOLIMPICA', '$JACUZZIS', '$TEMAZCAL', '$BAÑOS', '$elvelero', '$pergola', '$lasdelicias', '$doñatoña', '$cocobar', '$MINIBAR', '$MESEROS', '$CAJERAS', '$personal', '$termas', '$masajes', '$tratamientos', '$termasvip', '$feedback', '$fecha')";
